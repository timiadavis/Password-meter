...
function addLoadEvent(func) {
  ...
  if (typeof window.onload != "function") {
    ...
    window.onload = function () {
      ...
      document.querySelector("#password").classList.add("form-control");
      func();
    };
  }
}
...
function chkPass(pwd) {
  ...
  if (pwd) {
    ...
    oScorebar.style.width = nScore + "%";
    oScore.innerHTML = nScore + "%";
    oComplexity.innerHTML = sComplexity;

    if (nScore >= 75) {
      oScorebar.classList.remove("bg-danger", "bg-warning");
      oScorebar.classList.add("bg-success");
    } else if (nScore >= 50) {
      oScorebar.classList.remove("bg-danger", "bg-success");
      oScorebar.classList.add("bg-warning");
    } else {
      oScorebar.classList.remove("bg-warning", "bg-success");
      oScorebar.classList.add("bg-danger");
    }
  } else {
